...
/**
 * The class {@link EPSTurtleLogic} is responsible for creating the PostScript
 * file which contains the logic necessary for drawing the figure with respect
 * to the parameters and definitions parsed in the given JSON file
 * 
 * @author Philippe Gabriel
 * @version 1.13.4 2021-02-21
 */

public class EPSTurtleLogic implements Turtle {
    
    private BufferedWriter writer; //BufferedWriter for writing PostScript file
    static StringBuilder content; //Contents of Postscript file to be written
